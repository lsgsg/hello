...
<section>
	<div id="bonmun">
        	...
        	<form name="board_form" method="post" action="../concert/insert_img.php?table=<?=$_GET[table]?>" enctype="multipart/form-data">
        ...
        <textarea rows="30" cols="102" name="content" placeholder=" Content "><?=$item_content?></textarea>
            ...
            <div class="col4">
            	<label>썸네일 등록&nbsp;&nbsp;&nbsp;</label><input type="file" name="upfile[]">
                <span>(가로 세로 픽셀 동일)</span>
            </div>
          
            <div class="col5">
            	<label>이미지 파일1&nbsp;&nbsp;</label><input type="file" name="upfile[]">
            </div>
      
            <div class="col5">
            	<label>이미지 파일2&nbsp;&nbsp;</label><input type="file" name="upfile[]">
            </div>
         	<div class="clear"></div>
            <div id="write_button">
