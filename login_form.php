...
<body>
<form name="member_form" method="post" action="login.php" id="shake">
	<h2><img src="img/helloonlygul.png"></h2>
    <input name="id" type="text" placeholder="Username" class="login_input" required/>
        <input name="pass" type="password" placeholder="Password" class="login_input" required/>
